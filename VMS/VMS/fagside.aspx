...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="Row">
        <div class="col-md-4">
            <asp:Label ID="fagnavnLbl" runat="server" Text="fagnavn: eks Markedsføringsledelse"></asp:Label></div>
        <div class="col-md-4">
            <asp:Label ID="pensumLbl" runat="server" Text="Pensum:"></asp:Label></div>
        ...
        <div class="col-md-2">
            <asp:Label ID="spm1RatingLbl" runat="server"></asp:Label></div>
    </div>
    <br />
    <br />
    <br />
    <div class="Row">
        <div class="col-md-4">
            <asp:Label ID="foreleserLbl" runat="server" Text="Foreleser: Vetle Haugan"></asp:Label></div>
        <div class="col-md-4">
            <asp:Label ID="kvalitetLbl" runat="server" Text="Forelesningskvalitet:"></asp:Label></div>
        ...
        <div class="col-md-2">
            <asp:Label ID="spm2RatingLbl" runat="server"></asp:Label></div>
    </div>
    <br />
    <br />
    <br />
    <div class="Row">
        <div class="col-md-4">
            <asp:Label ID="studieretningLbl" runat="server" Text="Studie: It og informasjonssystemer"></asp:Label></div>
        <div class="col-md-4">
            <asp:Label ID="vanskelighetsgradLbl" runat="server" Text="Vanskelighetsgrad:"></asp:Label></div>
        ...
        <div class="col-md-2">
            <asp:Label ID="spm3RatingLbl" runat="server"></asp:Label></div>
    </div>
    <br />
    <br />
    <br />
    <div class="Row">
        <div class="col-md-4">
            <asp:Label ID="forkursLbl" runat="server" Text="Forkurs: Prg1000"></asp:Label></div>
        <div class="col-md-4">
            <asp:Label ID="pensumFormidlingLbl" runat="server" Text="Pensumformidling:"></asp:Label></div>
        ...
        <div class="col-md-2">
            <asp:Label ID="spm4RatingLbl" runat="server"></asp:Label></div>
    </div>
    <br />
    <br />
    <br />
    <div class="Row">
        <div class="col-md-4">
            <asp:Label ID="placeholder" runat="server" Text=""></asp:Label></div>
        <div class="col-md-4">
            <asp:Label ID="fagRelevantLbl" runat="server" Text="Om faget er relevant for linjen:"></asp:Label></div>
        ...
        <div class="col-md-2">
            <asp:Label ID="spm5RatingLbl" runat="server"></asp:Label></div>
    </div>
    <br />
    <br />
    <br />
